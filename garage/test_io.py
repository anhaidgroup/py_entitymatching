...
A = mg.read_csv_metadata(p+'/data/fp_ss_clean_df.csv', key='DRUG_ID',
                         low_memory=False)

B = mg.read_csv_metadata(p+'/data/sh_clean_df.csv', key='DRUG_ID',
                         low_memory=False)

C = mg.read_csv_metadata(p+'/garage/OV_GENERIC_NAME/0.csv',
                         ltable=A, rtable=B, fk_ltable='l_DRUG_ID',
                         fk_rtable='r_DRUG_ID', key='_id')
print('Hi')