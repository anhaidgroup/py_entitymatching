...
def debug_blocker(ltable, rtable, candidate_set, output_size=200,
    ...
    Args:
        ...
        rtable (DataFrame): the other table for entity matching.
        ...
        attr_corres (list): a list of attribute correspondence tuples.
            ...
            user need to manually specify the attribute correspondence.
            ...
            this list, the Magellan builtin function for finding the
            attribute correspondence list will be called. But we highly
            recommend the users manually specify the attribute
            correspondence, unless the schemas of ltable and rtable are
            identical.
